...
export default function OfficerDisp({ img, name, position, school, email, link}) {
    return (
        <a href={link} className="flex flex-col items-center justify-center bg-zinc-100 border-5 border-[#060852] px-5 md:px-0 py-7 rounded-2xl transition-transform duration-300 hover:scale-103 cursor-pointer">
            <Image
                className="pb-5"
                src={img}
                alt="Next.js logo"
