    ...
    return (
        ...
        <main className="flex flex-1 w-full flex-col items-center justify-between bg-[#060852] sm:items-start"> 
            <div className="flex flex-col w-full justify-between items-center h-full text-[#040531] bg-white py-20">
                <h1 className="text-5xl text-left px-[5%] pt-10 font-bold">Meet Your 2025-2026 Student Officer Team</h1>
                <div className="flex flex-col w-full justify-between items-center h-full px-10 py-12 gap-y-10">             
                    <h1 className="text-4xl text-left px-[5%] pt-5 font-bold underline">State Officers</h1>
                    <div className="grid grid-cols-2 gap-25 items-center justify-center w-[80%]">
                    ...
                    <h1 className="text-4xl text-left px-[5%] pt-15 font-bold underline">Regional Officers</h1>
                    <div className="grid grid-cols-2 gap-25 items-center justify-center w-[80%]">
                ...
                <a href="/students/apply" className="bg-red-500 w-[20%] h-10 rounded-lg text-white flex flex-row justify-center items-center transition-transform duration-300 hover:bg-[#ad0707] cursor-pointer">
                    <h1 className="text-xl">Apply for Office</h1>
                </a>
            </div>    
        </main>
        </div>
