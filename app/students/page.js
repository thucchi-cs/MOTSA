      ...
      <main className="flex flex-1 w-full flex-col items-center justify-between bg-[#060852] sm:items-start"> 
        <div className="flex flex-col w-full relative">
          ...
          <div className="flex flex-col absolute bottom-0 px-5 md:px-30 w-full text-center items-start text-left z-10 py-10">
            ...
            <h1 className="w-full text-3xl md:text-8xl font-semibold text-center text-zinc-50">
              Compete
            </h1>
            <h1 className="w-full text-3xl md:text-8xl font-semibold text-right text-zinc-50">
              Lead
            </h1>
          </div>  
        </div> 
