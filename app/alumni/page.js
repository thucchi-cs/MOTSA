    ...
    <div className="flex flex-col items-center justify-center font-sans bg-[#072c5c]">
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-between bg-[#072c5c] sm:items-start">
        <div className="flex flex-col w-full justify-between items-center h-full text-[#040531] bg-white pb-10 md:py-20">
          <h1 className="text-3xl md:text-5xl text-center px-[5%] pt-10 font-bold">Past Officers - 2025-2026</h1>
          ...
          <div className="flex flex-col items-center gap-y-4 mt-4">
            ...
            <Link href="/alumni/2024-2025" className="bg-[#072c5c] h-10 px-6 rounded-lg text-white flex flex-row justify-center items-center transition-transform duration-300 hover:bg-[#0a3d7a] cursor-pointer">
              <h1 className="text-sm md:text-xl">View 2024-2025 Officer Team</h1>
            </Link>
          </div>
        </div>
      </main>
