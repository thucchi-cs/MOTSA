    ...
    <div className="flex flex-col  items-center justify-center bg-zinc-50 font-sans dark:bg-[#040531]">
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-between bg-white dark:bg-[#060852] sm:items-start"> 
        <div className="flex flex-col w-full justify-between items-center h-full text-[#040531] bg-white py-20">
          <h1 className="text-5xl text-left px-[5%] pt-10 font-bold">10 Steps to Starting a Chapter</h1>
          <div className="flex flex-col w-full justify-between items-center h-full px-10 py-12 gap-y-10">
            ...
            <h1 className="text-3xl text-left px-[5%] pt-5 font-bold">1. The Organizing Committee</h1>
            <li className="text-2xl w-[60%] leading-relaxed text-left">
            ...
            <p className="text-2xl w-[60%] leading-relaxed text-left">
            ...
            <h1 className="text-3xl text-left px-[5%] pt-15 font-bold">2. The Recruitment Meeting</h1>
            <p className="text-2xl w-[60%] leading-relaxed text-left">
            ...
            <li className="text-2xl w-[50%] leading-relaxed text-left">
            ...
            <h1 className="text-3xl text-left px-[5%] pt-15 font-bold">3. The Membership Drive</h1>
            <p className="text-2xl w-[60%] leading-relaxed text-left">
            ...
            <h1 className="text-3xl text-left px-[5%] pt-15 font-bold">4. Officer Elections</h1>
            <p className="text-2xl w-[60%] leading-relaxed text-left">
            ...
            <h1 className="text-3xl text-left px-[5%] pt-15 font-bold">5. The Officers' First Order of Business</h1>
            <p className="text-2xl w-[60%] leading-relaxed text-left">
            ...
            <h1 className="text-3xl text-left px-[5%] pt-15 font-bold">6. Chapter Committees</h1>
            <p className="text-2xl w-[60%] leading-relaxed text-left">
            ...
            <h1 className="text-3xl text-left px-[5%] pt-15 font-bold">7. Develop a Plan of Action (aka, PA, or Calendar of Activities)</h1>
            <p className="text-2xl w-[60%] leading-relaxed text-left">
            ...
            <h1 className="text-3xl text-left px-[5%] pt-15 font-bold">8. Vote on the Plan of Action</h1>
            <p className="text-2xl w-[60%] leading-relaxed text-left">
            ...
            <h1 className="text-3xl text-left px-[5%] pt-15 font-bold">9. Get Involved!</h1>
            <p className="text-2xl w-[60%] leading-relaxed text-left">
            ...
            <h1 className="text-3xl text-left px-[5%] pt-15 font-bold">10. The Advisor's Continuing Role</h1>
            <p className="text-2xl w-[60%] leading-relaxed text-left">
